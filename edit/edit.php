    ...
    if (isset($_POST["submit"])) {
        ...
        if (edit($_POST) > 0) {
            echo '<script>
                    ...
                    document.location.href = "../halamanUtama/halamanUtama.php";
                </script>';
            ...
            <div class="row">
                ...
                <div class="col-lg-4 data ">
                    <form action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $siswa[0]["id"] ?>">

                        <!-- nama  -->
                        <label for="nama">Nama : </label>
                        <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan Nama" required value="<?php echo $siswa[0]["nama"] ?>">
                        <!-- akhir nama  -->

                        <!-- tanggal  -->
                        <label for="tanggal_lahir">Tanggal lahir : </label>
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" required value="<?php echo $siswa[0]['tanggal_lahir']; ?>">
                        <!-- akhir tanggal  -->
                        ...
                        <div>
                            <label class="me-4">
                                    <input type="radio" name="jenis_kelamin" value="L" required <?php echo $siswa[0]["jenis_kelamin"] == "L" ? 'checked' : ''; ?>> Laki-Laki
                                </label>
                            <label>
                                    <input type="radio" name="jenis_kelamin" value="P" required <?php echo $siswa[0]["jenis_kelamin"] == "P" ? 'checked' : ''; ?>> Perempuan
                                </label>
                        </div>
                        <!-- akhir jenis kelamin  -->
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder="Masukan Email" required value="<?php echo $siswa[0]["email"] ?>">
                        <!-- akhir email  -->

                        <!-- Kelas  -->
                        <div>Kelas :</div>
                        <select name="kelas" id="kelas" class="form-select " aria-label="Default select example" required>
                            <option value="IPA" required  <?php echo $siswa[0]["kelas"] == "IPA" ? 'selected' : ''; ?>>IPA</option>
                            <option value="IPS" required  <?php echo $siswa[0]["kelas"] == "IPS" ? 'selected' : ''; ?>>IPS</option>
                            <option value="BAHASA" required <?php echo $siswa[0]["kelas"] == "BAHASA" ? 'selected' : ''; ?>>BAHASA</option>
                        </select>
                        <!-- akhir kelas  -->

                        <!-- button  -->
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success" name="submit" >Kirim data</button>
                        </div>
                        <!-- akhir button  -->
                    </form>
                </div>
